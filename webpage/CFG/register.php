...
<body>
	...
	<div id="background">
		...
		<div id="loginContainer">
			...
			<div id="loginText">
				<h1>Get Great Service now</h1>
				<h2>Get served to best services for minimal Price</h2>
				<ul>
					<li>Discover equipments you'll need to work with</li>
					<li>Maintain your order Details</li>
					<li>Analyse and Summarize your orders</li>
				</ul>
			</div>
