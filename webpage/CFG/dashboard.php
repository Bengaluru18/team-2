		...
		<div class="row">
			<div class="col-md-4">
				<div class="card mx-auto" style="width: 18rem;">
				  <img class="card-img-top mx-auto" style="width:60%;"src="./assets/images/profile-pics/head_emerald.png" alt="Card image cap">
				  <div class="card-body">
				    <h5 class="card-title">Profile Details</h5>
				    <p class="card-text">ABC</p>
				    <p class="card-text">Admin</p>
				    <p class="card-text">LastLogin: xxxx-xx-xx</p>
			...
			<div class="col-md-8">
				<div class="jumbotron" style="width:100%;height:100%;">
					...
					<div class="row">
						<div class="col-sm-6">
							<iframe src="http://free.timeanddate.com/clock/i6bcm1iu/n438/szw110/szh110/cf100/hnce1ead6" frameborder="0" width="110" height="110">
							</iframe>
						</div>
						<div class="col-sm-6">
							<div class="card">
			...
			<div class="col-md-4">
				<div class="card">
			      <div class="card-body">
			        ...
			        <p class="card-text">Here you can manage Categoies</p>
